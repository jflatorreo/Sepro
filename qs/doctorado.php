...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var textos=['<th align="left" valign="top" scope="col"><table width="80%" border="0" cellspacing="0" cellpadding="0"><tr><th align="left" valign="top" class="style2" scope="col">Delio Alexander Balcázar Camacho</th></tr></table></th>',
                        '<th align="left" valign="top" scope="col"><table width="80%"border="0"cellspacing="0"cellpadding="0"><tr><th align="left"valign="top"class="style2"scope="col">Iván Darío Cárdenas Barbosa</th></tr><tr></table></th>',
                        '<th align="left" valign="top" scope="col"><table width="80%"border="0"cellspacing="0"cellpadding="0"><tr><th width="246"align="left"valign="top"class="style2"scope="col">Oscar Palacio Leon</th></tr></table></th>',
                        '<th align="left" valign="top" scope="col"><table width="80%"border="0"cellspacing="0"cellpadding="0"><tr><th align="left"valign="top"class="style2"scope="col">Laura Vanessa Palacios Arguello</th></tr></table></th>',
                        '<th align="left" valign="top" scope="col"><table width="80%"border="0"cellspacing="0"cellpadding="0"><tr><th align="left"valign="top"class="style2"scope="col">Oscar Alexander Rincón Guevara</th></tr></table></th>',
                        '<th align="left" valign="top" scope="col"><table width="80%"border="0"cellspacing="0"cellpadding="0"><tr><th align="left"valign="top"class="style2"scope="col">Egdda Patricia Vanegas Escamilla</th></tr></table></th>',
                        '<th align="left" valign="top" scope="col"><table width="80%"border="0"cellspacing="0"cellpadding="0"><tr><th align="left"valign="top"class="style2"scope="col">Frank Alexander Ballesteros Riveros</th></tr></table></th>',
